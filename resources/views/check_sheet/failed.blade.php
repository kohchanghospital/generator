    ...
    <x-slot name="header">
        <div class="flex sticky justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('รายการตรวจเช็คเครื่องปั่นไฟไม่ผ่าน') }}
            </h2>
                        ...
                        <table class="min-w-full border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                            <thead class="bg-gray-100 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-sm font-semibold">วันที่ตรวจ/เวลาที่ตรวจ</th>
                                    <th class="px-4 py-3 text-left text-sm font-semibold">ผู้บันทึก</th>
                                    <th class="px-4 py-3 text-left text-sm font-semibold">หมายเลขเครื่อง</th>
                                    <th class="px-4 py-3 text-center text-sm font-semibold">รายการตรวจเช็ค</th>
                                    ...
                                    <th class="px-4 py-3 text-center text-sm font-semibold">แก้ไข</th>
                                </tr>
                            </thead>
                            ...
                            @forelse($lists as $item)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <a href="{{ route('check_sheet.show', $item->id) }}"
